...
# Other tutoral (available in MOGSA)
Chen Meng has written some great vignettes available in the [mogsa package](http://www.bioconductor.org/packages/release/bioc/html/mogsa.html).  
See  mogsa moCluster (find clusters tutorial) and moGSA (gene set enrichment analysis) on multi-omics data.  These are available in the devel verioson of [mogsa](http://www.bioconductor.org/packages/devel/bioc/html/mogsa.html). 
...
```{r loadSE}
setwd("/Users/aedin/git_src/bioc2015multiomicsworkshop")
